...
<section class="feed mt-10">
    ...
    <form method="POST" class="config-form" enctype="multipart/form-data" action="configuration_action.php">
        <label>
            Novo Avatar: <br>
            <input type="file" name="avatar"><br>
            <img class="mini-photo" src="<?=$base?>/media/avatars/<?=$userInfo->avatar?>">
        </label>

        <label>
            Novo Capa: <br>
            <input type="file" name="cover"><br>
            <img class="mini-photo" src="<?=$base?>/media/covers/cover.jpg">
        </label>
